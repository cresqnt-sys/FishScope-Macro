...
def _create_combo_arrow_svg(color='#e0e0e0'):
    svg_content = (
    ...
    svg_dir = os.path.join(_tempfile.gettempdir(), 'fishscope_arrows')
    os.makedirs(svg_dir, exist_ok=True)
    svg_path = os.path.join(svg_dir, f'arrow_{safe_color}.svg')
    with open(svg_path, 'w') as f:
        f.write(svg_content)
    return svg_path.replace('\\', '/')

_ARROW_LIGHT = _create_combo_arrow_svg('#e0e0e0')
_ARROW_GRAY = _create_combo_arrow_svg('#888888')
_ARROW_BLUE = _create_combo_arrow_svg('#4a9eff')
...
class CalibrationUI (QMainWindow ):
    ...
    def enable_all_notifications (self ):
        ...
        self .automation .webhook_macro_started =True 
        self .automation .webhook_macro_stopped =True 
        ...
        self .webhook_macro_started_checkbox .setChecked (True )
        self .webhook_macro_stopped_checkbox .setChecked (True )
    ...
    def disable_all_notifications (self ):
        ...
        self .automation .webhook_macro_started =False 
        self .automation .webhook_macro_stopped =False 
        ...
        self .webhook_macro_started_checkbox .setChecked (False )
        self .webhook_macro_stopped_checkbox .setChecked (False )
    ...
    def create_auto_reconnect_tab (self ):
        ...
        self .window_mode_combo .setStyleSheet (f'\n            QComboBox {{\n                background-color: #3d3d3d;\n                border: 1px solid #555555;\n                border-radius: 6px;\n                padding: 4px 8px;\n                color: #e0e0e0;\n                font-size: 11px;\n                min-width: 100px;\n            }}\n            QComboBox:hover {{\n                border-color: #666666;\n            }}\n            QComboBox::drop-down {{\n                subcontrol-origin: padding;\n                subcontrol-position: top right;\n                width: 20px;\n                border: none;\n                background-color: transparent;\n            }}\n            QComboBox::down-arrow {{\n                image: url({_ARROW_GRAY});\n                width: 10px;\n                height: 6px;\n            }}\n            QComboBox::down-arrow:hover {{\n                image: url({_ARROW_BLUE});\n            }}\n            QComboBox QAbstractItemView {{\n                background-color: #3d3d3d;\n                border: 1px solid #555555;\n                selection-background-color: #4a9eff;\n                selection-color: white;\n                color: #e0e0e0;\n                outline: none;\n            }}\n            QComboBox QAbstractItemView::item {{\n                padding: 4px 8px;\n            }}\n            QComboBox QAbstractItemView::item:hover {{\n                background-color: #555555;\n            }}\n        ')
        ...
        reconnect_note =QLabel ('[i] Once reconnected, detects RobloxPlayerBeta.exe -> waits -> sends \\ -> Enter -> \\ sequence. If you have a slow PC, increase the delay time.')
    ...
    def create_calibrations_tab (self ):
        ...
        self .premade_combo .setStyleSheet (f'\n            QComboBox {{\n                background-color: #2d2d2d;\n                color: #e0e0e0;\n                border: 1px solid #555555;\n                border-radius: 6px;\n                padding: 6px 10px;\n                font-size: 11px;\n                min-width: 180px;\n            }}\n            QComboBox:hover {{\n                border-color: #666666;\n            }}\n            QComboBox::drop-down {{\n                subcontrol-origin: padding;\n                subcontrol-position: top right;\n                width: 20px;\n                border: none;\n                background-color: transparent;\n            }}\n            QComboBox::down-arrow {{\n                image: url({_ARROW_LIGHT});\n                width: 10px;\n                height: 6px;\n            }}\n            QComboBox::down-arrow:hover {{\n                image: url({_ARROW_BLUE});\n            }}\n            QComboBox QAbstractItemView {{\n                background-color: #2d2d2d;\n                color: #e0e0e0;\n                border: 1px solid #555555;\n                selection-background-color: #4a9eff;\n                selection-color: white;\n                outline: none;\n            }}\n            QComboBox QAbstractItemView::item {{\n                padding: 6px 10px;\n            }}\n            QComboBox QAbstractItemView::item:hover {{\n                background-color: #3a3a3a;\n            }}\n        ')
    ...
    def create_settings_tab (self ):
        ...
        self .auto_sell_config_combo .setStyleSheet (f'\n            QComboBox {{\n                background-color: #2d2d2d;\n                color: #e0e0e0;\n                border: 1px solid #555555;\n                border-radius: 6px;\n                padding: 6px 10px;\n                font-size: 11px;\n                min-width: 180px;\n            }}\n            QComboBox:hover {{\n                border-color: #666666;\n            }}\n            QComboBox::drop-down {{\n                subcontrol-origin: padding;\n                subcontrol-position: top right;\n                width: 20px;\n                border: none;\n                background-color: transparent;\n            }}\n            QComboBox::down-arrow {{\n                image: url({_ARROW_LIGHT});\n                width: 10px;\n                height: 6px;\n            }}\n            QComboBox::down-arrow:hover {{\n                image: url({_ARROW_BLUE});\n            }}\n            QComboBox QAbstractItemView {{\n                background-color: #2d2d2d;\n                color: #e0e0e0;\n                border: 1px solid #555555;\n                selection-background-color: #4a9eff;\n                selection-color: white;\n                outline: none;\n            }}\n            QComboBox QAbstractItemView::item {{\n                padding: 6px 10px;\n            }}\n            QComboBox QAbstractItemView::item:hover {{\n                background-color: #3a3a3a;\n            }}\n        ')
    ...
    def import_config (self ):
        ...
        try :
            ...
            coord_frame =QFrame ()
            coord_frame .setStyleSheet ('QFrame { border: 1px solid #555; border-radius: 6px; margin: 5px; }')
            ...
            settings_frame .setStyleSheet ('QFrame { border: 1px solid #555; border-radius: 6px; margin: 5px; }')
