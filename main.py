...
from PyQt6.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QHBoxLayout, QWidget, QPushButton, QLabel, QFrame, QScrollArea, QMessageBox, QGroupBox, QComboBox, QCheckBox, QLineEdit, QSpinBox, QTabWidget
        ...
        try:
            ...
            while True:
                ...
                if found_pos is None:
                    autoit.mouse_click('left')
                elif not extra_click_performed:
                    autoit.mouse_click('left')
